...
class Camera
{
  Camera()
  {
    position      = new PVector( 1098, 169, -156.6 ); // initial position
    theta         = -4.7; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.21; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
